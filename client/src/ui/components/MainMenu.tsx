...
export function MainMenu({ onPlay, onBack, onCancelMatchmaking, isConnecting = false }: MainMenuProps) {
  ...
  useEffect(() => {
    ...
    if (!currentName || currentName.trim() === '' || currentName === GUEST_DEFAULT_NICKNAME) {
  ...
  return (
    <div class="main-menu">
      ...
      <div class="menu-footer">
        Slime Arena v{__APP_VERSION__} • <a href="https://github.com/komleff/slime-arena" target="_blank" rel="noopener noreferrer">GitHub</a>
      </div>
    </div>
  );
}
