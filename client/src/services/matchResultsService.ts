...
//
// Gemini P1: Почему не ждём серверных наград?
// - Instant feedback критичен для UX (экран результатов показывается сразу)
// - Серверный запрос добавил бы задержку 100-500ms
