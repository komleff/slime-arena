...
### v0.3.0 — UI Refactoring & Preact Integration (7 января 2026)
- **UI миграция:** Полный переход на Preact и Signals для интерфейса.
- **UIBridge:** Новый мост между Canvas-рендером и реактивным UI.
- **ScreenManager:** Система управления экранами (Меню, HUD, Таланты, Результаты).
- **Оптимизация:** HUD обновляется с частотой 10 Гц для экономии ресурсов.
- **Исправления:** Устранены критические race conditions при переподключении и "призраки" игроков.

### v0.2.2 — Mobile & CI/CD (5 января 2026)
- **Mobile Input:** Исправлено залипание управления на тач-устройствах.
- **CI/CD:** Автоматизирована сборка Docker-образов через GitHub Actions.
