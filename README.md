...
- **Шипастые препятствия**: теперь визуально отличаются от столбов — серая основа с красными шипами и знаком ⚠.
...
- **Награды сундуков**: при открытии сундука появляется вспышка и всплывающий текст с наградой.
- **Ускорение x2**: базовая тяга и угловой момент слаймов увеличены в 2 раза.
