...
- **Tech Debt Batch 1** (31 дек 2025):
  - PvP укус: награды рассчитываются от фактической потери массы + проверка инварианта.
  - Freeze при Results: орбы и сундуки замораживаются.
  - Dash: корректная обработка worldShape (rectangle/circle) через clampPointToWorld.
