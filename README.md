...
- Собиратель: стартовое умение `pull`, `slow` перенесено в общий пул, притяжение тянет к пасти.
- Для ПК отключён виртуальный `joystick`, управление курсором от центра слайма.
- Движение: увеличены `thrustForwardN`, лимиты скорости и `massScaling.thrustForwardN`.
...
- Добавлена обратная связь награды сундуков: всплывающий текст у персонажа и вспышка панели усилений.
