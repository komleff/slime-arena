...
## Задача: PR #4 Refactor mass-based combat system (В РАЗРАБОТКЕ 🔄)
...
- [x] Обновление конфигурации:
  - balance.json: biteDamagePctOfMass (0.02 → 0.5) для всех слаймов
  - balance.json: добавлен biteVictimMassGainPct: 0.25
