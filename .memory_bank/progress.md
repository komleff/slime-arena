...
- [x] GDD обновлён до v2.6.0 (27 декабря 2025)
...
### GDD 2.6.0 — Ключевые изменения
**Классы:**
- Переработаны пассивы (убраны ссылки на HP)
- Уникальные таланты для каждого класса (по 3 штуки)

**Умения:**
- Щит не снимается при атаке (можно кусать под щитом)
- Притяжение замедляет слаймов на 30%
- Новые: Плевок, Бомба, Отталкивание, Мина

**Бой:**
- Механика «пасть в пасть»: тяжёлый побеждает (разница >10%)
- Токсичная лужа при смерти (40м, 3сек, −1%/сек)
- 6-8 мелких пузырей вместо 3 крупных

**Зоны:**
- 5 типов: Нектар, Лёд, Слизь, Лава, Турбо
- Комбинированные эффекты
- Hot Zones с индикаторами (стрелки, звук)

**Таланты:**
- 15 обычных + 10 редких + 5 эпических
- Классовые уникальные (по 3 на класс)
- Фильтрация по наличию умений
