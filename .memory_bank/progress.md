...
- **План исправления бага джойстика:** Проведен анализ и составлен план рефакторинга для исправления бага с дрейфом джойстика. План сохранен в `docs/joystick-refactor-plan-gemini.md`.
