...
## Контроль изменений
- **last_checked_commit**: fix/v0.3.1-docker-infra @ 7 января 2026
...
- **v0.3.1 Docker Infra**: ЗАВЕРШЕНО

## Последние изменения (v0.3.1)

### v0.3.1: Инфраструктура и стабильность

**Ветка:** `fix/v0.3.1-docker-infra`
**Статус:** 🟢 ЗАВЕРШЕНО

**Цель:** Обеспечить стабильный запуск проекта в Docker-контейнерах и внедрить результаты разработки за 6-7 января (Sprint 3, 4, UI fixes).

**Выполненные задачи:**
- ✅ **Backup/Restore (PR #47):** Созданы скрипты `.ps1` и `.sh` для PostgreSQL. Протестировано восстановление (Stage D: 19/19).
- ✅ **Integration (PR #36, #45):** Связка MatchServer с MetaServer, отправка результатов матча.
- ✅ **Mobile & Flight Assist (PR #39):** Настройка управления для тач-устройств и помощника пилотирования.
- ✅ **UI v0.3.0 Fixes (PR #37):** Исправлено 15 известных проблем интерфейса.
- ✅ **Docker Infra:** Устранены ошибки типизации в `ArenaRoom.ts`, настроена предварительная сборка `shared`, стандартизированы имена контейнеров и порты.
