...
### Фокус сессии
- **Диагностика мобильного джойстика:** добавлены лог-события pointer/resize/visibility и клики умений (включаются через `?debugJoystick=1`).
- **Рефакторинг джойстика (шаг 2):** логика и конфиг вынесены в `client/src/input/joystick.ts`, `main.ts` использует модульные функции.
