...
- **Документ:** переработан план будущего спринта по мобильному управлению `docs/soft-launch/Sprint-Next-Mobile-Controls-Plan.md`.
- **Уточнение:** учесть поведение пользователя — интерпретировать вектор пальца как target heading для behavior-aware yaw в Fly-by-wire.
