...
- **Релиз v0.2.1 опубликован:** контейнеры и release notes обновлены, исправлено мобильное управление.
...
### Следующие шаги
- **Релиз v0.2:** обновить описание релиза и README ссылками на контейнеры (если ещё не сделано).
