...
Как нетехнический специалист создал готовую к запуску игру за 31 день с AI-агентами.
...
**Ключевое наблюдение:** Выделить одного агента для управления другими.
...
| **Architect** | Роль агента: планирует, не пишет код |
| **Beads** | Система управления задачами в Git |
| **CI** | Непрерывная интеграция — автопроверки кода |
| **Memory Bank** | Внешняя память проекта (`.memory_bank/`) |
| **PR** | Запрос на слияние изменений |
| **Seeded RNG** | Генератор случайных чисел с фиксированным началом |
| **Worktree** | Изолированная рабочая директория Git |
| **Zero Trust** | Не доверять без проверки |
