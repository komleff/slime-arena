...
**Scatter Orbs (цветные пузыри):**
- При любом уроне (укус, снаряд) часть массы вылетает цветными пузырями
- Цвет пузырей соответствует цвету жертвы (по classId):
  - Hunter: зелёный (#4ade80)
  - Warrior: красный (#f87171)
  - Collector: синий (#60a5fa)
...
- Сила притяжения: 50 м/сек к центру слайма
- Визуал: фиолетовое магнитное поле
