...
- Визуализирует текущий вектор ввода игрока
- Длина пропорциональна интенсивности (джойстик, расстояние до курсора мыши)
- Показывает куда направлен слайм в данный момент
- Помогает понять текущее управление
