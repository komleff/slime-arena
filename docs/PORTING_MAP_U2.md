...
**Источник истины для Slime Arena (не менять):** `SlimeArena-Architecture-v1.5.md` (v1.5.1) + `SlimeArena-GDD-v2_4.md` (v2.4.1) + `SlimeArena-Plan-v1.8.md` (v1.8.1).
...
Контрольная точка:
- ADR приняты и не противоречат `SlimeArena-Architecture-v1.5.md`.
...
- Обновление документов (архитектуру править только отдельным согласованным PR/ADR; в рамках переноса — не противоречить `SlimeArena-Architecture-v1.5.md`).
