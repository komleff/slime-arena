...
### 4.5 Параметры настройки (см. раздел 5)
...
| Heading | Целевое направление (угол курса) объекта в плоскости движения, задаётся игроком через вектор ввода | target heading |
...
| Yaw | Угловое вращение вокруг вертикальной оси, описывающее скорость/ускорение изменения heading | рыскание |
