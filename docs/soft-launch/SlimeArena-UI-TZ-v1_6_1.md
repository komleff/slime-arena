...
## Резюме изменений v1.6.2

Обновление лейаута Лобби (горизонтальная ориентация):

1. **LobbyScreen:** Убраны карточки выбора класса (перенесены в Matchmaking).
2. **Навигация:** Перенесена в левый нижний угол.
3. **Кнопка «Арена»:** Перенесена в правый нижний угол.
4. **Центр:** Отображается текущий скин героя.
...
stateDiagram-v2
    ...
    LobbyScreen --> MatchmakingScreen: "Арена"
...
| Навигационная панель | Нижний левый угол | Иконки: Магазин, Пропуск, Рейтинги, Достижения, Настройки | GDD-UI §13 |
| Герой (Скин) | Центральная часть | 3D-модель/Спрайт текущего слайма | TZ v1.6.2 |
| Кнопка «Арена» | Нижний правый угол | Запуск матчмейкинга (главная кнопка действия) | GDD-UI §13 |

**Правило видимости навигации:** Иконки P2-экранов [MUST] скрываться при `features.X=false`.

**Примечание:** Выбор класса осуществляется только на экране `MatchmakingScreen`.
**Примечание 2:** Макет для вертикальной ориентации будет предоставлен позже.
...
| `ready` | Герой анимирован, кнопка «Арена» активна |
...
|----------|-----------|---------|
| Нажатие «Арена» | Переход на `MatchmakingScreen` | `matchmaking_join` |
...
| Выбор класса | Центральная часть | Карточки классов (Охотник, Воин, Собиратель) | TZ v1.6.2 |
...
### Версия 1.6.2 (13 января 2026)

Обновление лейаута Лобби (горизонтальная ориентация):
- Кнопка «Арена» перенесена в правый нижний угол.
- Навигация перенесена в левый нижний угол.
- Убран выбор класса из Лобби (перенесен в Matchmaking).
- В центре Лобби отображается текущий скин.
