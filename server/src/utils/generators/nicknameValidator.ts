 ...
 *
 * ПРИМЕЧАНИЕ: Эти значения НЕ вынесены в balance.json, так как это
 * валидационные правила пользовательского ввода, а не параметры игрового баланса.
 * Изменение этих значений требует миграции БД и обновления клиента.
 */

/** Минимальная длина никнейма (символов) — защита от слишком коротких имён */
export const NICKNAME_MIN_LENGTH = 2;

/** Максимальная длина никнейма (символов) — ограничение для UI и БД */
export const NICKNAME_MAX_LENGTH = 20;

/**
 * Паттерн разрешённых символов.
 * Разрешены: латиница, кириллица, цифры, пробел, дефис, подчёркивание.
 * Запрещены: эмодзи, HTML-теги, спецсимволы.
 */
export const NICKNAME_ALLOWED_PATTERN = /^[A-Za-zА-Яа-яЁё0-9 _-]+$/;

/**
 * Объект конфигурации (для обратной совместимости и удобства).
 */
export const NICKNAME_CONFIG = {
  minLength: NICKNAME_MIN_LENGTH,
  maxLength: NICKNAME_MAX_LENGTH,
  allowedPattern: NICKNAME_ALLOWED_PATTERN,
};
