...
**Статус:** Завершено (main принят, 77432b8 отброшен, build/test ok)
...
**Статус:** Завершено (legacy удален, .u2/_ext/u2 в .gitignore)
...
**Статус:** 📋 Плануется в отдельном спринте
...
**Статус:** 📋 Плануется после талантов
